...
{
	/// <summary>
	/// The freshest scan known for a site — the Radar Atlas's detail read-out.
	///
	...
	/// history frames). Reporting only the archive made the Atlas read minutes staler than the loop
