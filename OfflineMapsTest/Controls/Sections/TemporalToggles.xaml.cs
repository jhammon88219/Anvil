...
namespace OfflineMapsTest.Controls.Sections
{
	...
	/// floating card (see <see cref="TemporalCards"/>). INDEPENDENT deselectable toggles projecting
	/// <see cref="MapViewModel.IsPastCast"/> etc. (Past/Now mutually exclusive; Fore stacks; all off = blank). The cog is
