...
namespace Anvil.Controls.Sections
{
	...
	/// ForeCast settings window while ForeCast (Outlook.IsOutlookVisible) is on — the ForeCast counterpart
	...
	/// surface. (Watches moved to the NowCast window / <see cref="WatchesViewModel"/>.)
	/// </summary>
