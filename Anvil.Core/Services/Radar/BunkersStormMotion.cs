...
namespace Anvil.Services
{
	...
	/// </remarks>
	// Verified 2026-09-03 on both paths: NVW live (matched the NWS's own VAD to 2°/5 kt on the same volume)
	// and the local VAD via PastCast Moore 2013.
	...
	// Read docs/radar/storm-motion.md (esp. §2.4 and §5) BEFORE changing anything here, and re-verify on
	// both paths after.
